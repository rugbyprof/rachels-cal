            ...
            for(var j=this.weekStart; j<this.days.length + this.weekStart; j++){
                ...
                if(cls.length == 0){
                    if(
                        ...
                        cls = "day weekend week"+workweek;
                    }else{
                        cls = "day week"+workweek;
                    }
                }

                if(dow > 0){
                    workString = getWorkTime(new Date(this.yy, this.mm, dow),workweek);
                    if(workString==0){
                        workString = "<br>"+"<span style='font-size:10pt;font-weight:bold;color:rgba(0, 0, 0, 1)'>OFF</span>";
                    }else{
                        workString = "<br>"+"<span style='font-size:10pt;font-weight:bold;color:rgba(0, 0, 0, .4)'>"+workString+"</span>";
                    }
                }
                ...
                if(dow == 0){
                    ...
                    _html += '<td class="' +cls+ '" id="'+id+'" year="' + year + '" month="' + month_ + '" day="' + dow + '"><span class="weekday">' +dow+workString+ '</span></td>';
                }else{
                    _html += '<td class="' +cls+ '" id="'+id+'" year="' + year + '" month="' + month_ + '" day="' + dow + '">' +dow+workString+ '</td>';
                }
...
function getWorkTime(day,work_week){
    var ww = [
        [0,"6-2","6-2","2-10",0,0,0],
        ["6-2","2-10","2-10",0,"6-2","6-2","6-2"],
        ["2-10",0,0,"6-2","2-10","2-10","2-10"]
    ]

    workString = "";
    var n = (day.getDay()-1)%7;
    if(n<0){
        n=6;
    }

    console.log(day,work_week,n)
    return ww[work_week][n];
}
